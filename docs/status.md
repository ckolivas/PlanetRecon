...
| Scientific reconstruction | Legacy Fourier estimators and blind prototypes, bounded oracle/gradient checks | Full-grid convergence incomplete; correct extended-scene model before further qualification |
...
Latest scientific evidence: [full-grid decision](../results/r10-full-grid-summary/DECISION.md).
