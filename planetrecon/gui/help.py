...
CONTROL_HELP = {
    ...
    'local_alignment': 'Optional local seeing correction using overlapping texture patches and an averaged reference anchored to the best selected frame. Keeps the same selected frames and adds no sharpening. Requires cached preprocessing and Motion model none; weak or ambiguous patches keep global alignment. Experimental: the Jupiter gain is small and processing is slower.',
