...
Suggested code edits should be applied directly to the source tree. 
...
When the only prompt response is a bug or crash reported, assume that addressing that bug is the next
required action.

Give a one line summary of the changes after each turn.
