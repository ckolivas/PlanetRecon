...
Stacking uses the original cached quality scores as linear frame weights.
The stronger squared-weight experiment was removed after visual review.
Existing standard-weight jobs and checkpoints remain usable; jobs that enabled
squared weighting require a fresh stack with standard weights.
